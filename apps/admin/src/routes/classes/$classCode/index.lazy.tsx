    ...
    <>
      ...
      { !classIsLoading && thisClass != null &&
        <div className='flex flex-col w-full h-[calc(100vh-6rem)] sm:h-full flex-1'>
          ...
          <div className='mt-4'>
            <div className='flex w-full overflow-auto gap-8 text-blue-700'>
              ...
              <div className='flex-1 flex flex-col gap-1'>
                ...
                <div className='w-full flex gap-4 sm:overflow-y-auto '>
                {
            ...
            <div className='mt-4 flex text-blue-700 gap-2 sm:gap-5 w-full flex-wrap sm:flex-nowrap justify-evenly'>
              {
                stats.map(({ label, icon, value}, idx) => (
                  <Link key={idx} to={`/classes/${classCode}/${_.lowerCase(label)}`} className='w-[calc(100%-0.5rem)] sm:w-full border-[1.5px] cursor-pointer border-transparent hover:border-blue-700/40'>
                    <StatCard
                      key={idx}
                      label={label}
                      icon={icon}
