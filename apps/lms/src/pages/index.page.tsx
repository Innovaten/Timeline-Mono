    ...
    return (
        <>
            <main className="w-screen h-screen bg-blue-50 md:p-16 overflow-hidden">
                ...
                <div className='absolute hidden sm:flex bottom-10 flex-col items-center gap-2 w-[calc(100vw-8rem)] m-auto text-blue-600'>
                ...
                >
                    <Form className='flex flex-col gap-4 sm:gap-6'>
                        ...
                        <div className='hidden sm:flex justify-end w-full'>
                            <p className='text-blue-700 underline-offset-2 underline cursor-pointer' onClick={() => { fadeParentAndReplacePage(pages['parent'], componentRef, pages['forgot'], 'flex') }}>Forgot your password?</p>
                        </div>
                        <Button
                            variant='primary'
                            isLoading={isLoading}
                        ...
                        <div className='sm:hidden flex justify-center w-full'>
                            <p className='text-blue-700 underline-offset-2 cursor-pointer underline' onClick={() => { fadeParentAndReplacePage(pages['parent'], componentRef, pages['forgot'], 'flex') }}>Forgot your password?</p>
                        </div>
                    </Form>
                </Formik>
            </div>
                ...
                >
                    <Form className='flex flex-col gap-4 sm:gap-6'>
                        <div className='my-3'>
                            ...
                            <p>We'll send you a One Time Pasword (OTP)</p>
                        </div>
