                    ...
                    <div className='mt-2'>
                        ...
                        <span className='mt-3 flex gap-2 flex-wrap items-center'>
                            <span className='bg-blue-300/10 border-blue-600/10 border-[1.5px] flex gap-1 items-center text-blue-700 rounded px-2 py-1 shadow-sm'>
                                <span>Author:</span>
                                <span className='font-light'>{module.createdBy?.firstName + " " + module.createdBy?.lastName}</span>
                            </span>
                            <span className='bg-blue-300/10 border-blue-600/10 border-[1.5px] flex gap-1 items-center text-blue-700 rounded px-2 py-1 shadow-sm'>
                                <span>Created:</span>
                                <span className='font-light'>{dayjs(module.createdAt).format("HH:mm - DD/MM/YY")}</span>
                            </span>
                            
                            { module.createdAt != module.updatedAt && 
                                <span className='bg-blue-300/10 border-blue-600/10 border-[1.5px] flex gap-1 items-center text-blue-700 rounded px-2 py-1 shadow-sm'>
                                    <span>Updated:</span>
                                    <span className='font-light'>{dayjs(module.updatedAt).format("HH:mm - DD/MM/YY")}</span>
                                </span>
                            }
                        </span>
                        <div className='w-full flex-1 mt-4 bg-blue-50 p-1 rounded-sm shadow'>
                        <h4 className='text-blue-800'> Lessons</h4>
