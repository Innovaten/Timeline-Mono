        ...
        <>
          <Dialog open={isOpen} onClose={onClose ?? function(){} } className="relative z-50 ">
            <div className="fixed inset-0 flex w-screen  backdrop-blur-[2px] items-center justify-center p-4">
              <DialogPanel className="min-w-[300px] max-h-[600px] xl:max-h-[700px] overflow-auto sm:min-w-[600px] min-h-[250px] text-blue-800 sm:max-w-lg relative space-y-3 border bg-white p-6 sm:p-12 rounded-lg shadow">
